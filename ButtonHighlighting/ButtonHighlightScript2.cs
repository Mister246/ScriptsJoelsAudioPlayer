...
// This class is currently in use by the right list of audio files.
{
    ...
    // dehighlights the button if it is already highlighted
    {
        ...
        {
            ProgressBarScriptV2.slider.interactable = false;
        ...
        // if button is not highlighted, highlight button:
        {
            ...
            ProgressBarScriptV2.slider.interactable = true;
            ...
            ScrollbarSelectedPlaylistListSectionScript.SnapScrollbarToButton(ControlPanelScript.GetIndexOfAudio(currentlyHighlightedButton.name));
        }
    }
